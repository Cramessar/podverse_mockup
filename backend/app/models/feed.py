...
class Feed(Base):
    ...
    # Note: last_parsed column doesn't exist in DB - removed for demo
    created_at: Mapped[Optional[DateTime]] = mapped_column(DateTime)
    updated_at: Mapped[Optional[DateTime]] = mapped_column(DateTime)
    parsing_priority: Mapped[Optional[int]] = mapped_column(Integer)
    last_parsed_file_hash: Mapped[Optional[str]] = mapped_column(String(255))
